...
void adapt_loop(double h, double time, double scale, nbody sim){
    ...
    //... during the simulation. We run this loop for the initial conditions of the earth but with less orbital speed (eccentric...
    //... orbits are more relevant for this part: yvel = 400. instead of = 581.) such that the maximum distance is 1. AU.
